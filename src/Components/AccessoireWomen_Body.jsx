...
import BannerAccessoireWomen from "../images/BannerAccessoireWomen.webp";
  ...
  const categories = [
    {
      name: "Dresses",
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/womens.jpg-0PE0yYlnyvd3tRFkNM9hlie1kdNV2q.jpeg",
      link: "/women/dresses",
    },
    {
      name: "Tops",
  ...
  return (
    <main className="w-full">
      ...
      <section className="relative h-[70vh] min-h-[500px] w-full overflow-hidden">
        ...
        <img
          src={BannerAccessoireWomen || "/placeholder.svg"}
